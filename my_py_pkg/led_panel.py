...
class LEDPanelNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(
            "LED Panel Node has been started.")
    ...
    def callback_set_led(self, request: SetLed.Request, response: SetLed.Response):
        # Validate the data received from the service request
        ...
        self.publish_led_states()  # Update the LED states immediately after setting
